                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                <form action="{{ route('account.processRegister') }}" method="post">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="password" value="{{ old('password_confirmation') }}" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" id="password_confirmation" value="" placeholder="Confirm Password" >
